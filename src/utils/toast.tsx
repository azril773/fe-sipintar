...
export function ToastNotification({
  ...
  return (
    <>
      <div
        className={`pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white dark:bg-zinc-800 w-full shadow-lg border border-gray-200 dark:border-zinc-700`}
      >
        <div
